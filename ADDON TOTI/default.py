...
Base = 'http://titupi.blogspot.com.es/2017/09/titulo.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.ADDON TOTI') #    modificar("el nombre de tu addons")
